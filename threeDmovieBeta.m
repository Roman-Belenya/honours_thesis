...
trial = importdata('C:\Users\marotta_admin\Desktop\Roman\Roman_P17\Roman_Occlusion_Cue_RightToLeft0002.exp');
...
fill3([0.34 0.34 0.87 0.87], [max(eyey) max(eyey) max(eyey) max(eyey)], ...
    [0.18 0.48 0.48 0.18], [0.95 0.95 0.95], 'LineWidth', 2)
...
if cues && ~isempty(strfind(trial.textdata{3}, '_Cue_'))
    line([0.359 0.359], [0.5414 0.5414], [0.18 0.48], ...
        'Color', [0.7 0.7 0.9])
    line([0.427 0.427], [0.5414 0.5414], [0.18 0.48], ...
        'Color', [0.7 0.7 0.9])
    line([0.495 0.495], [0.5414 0.5414], [0.18 0.48], ...
        'Color', [0.7 0.7 0.9])
    line([0.563 0.563], [0.5414 0.5414], [0.18 0.48], ...
        'Color', [0.7 0.7 0.9])
    line([0.631 0.631], [0.5414 0.5414], [0.18 0.48], ...
        'Color', [0.7 0.7 0.9])
    line([0.699 0.699], [0.5414 0.5414], [0.18 0.48], ...
        'Color', [0.7 0.7 0.9])
    line([0.767 0.767], [0.5414 0.5414], [0.18 0.48], ...
        'Color', [0.7 0.7 0.9])
    line([0.835 0.835], [0.5414 0.5414], [0.18 0.48], ...
        'Color', [0.6 0.6 0.9])
end
